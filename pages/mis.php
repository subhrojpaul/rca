<?php
    ...
    //DSR
    $application_received_by_rca_dsr_qry                = "select * from application_received_by_rca_dsr";
    $application_received_by_rca_dsr_res                = runQueryAllRows($dbh, $application_received_by_rca_dsr_qry, array());

    $application_in_process_with_immigrations_dsr_qry   = "select * from application_in_process_with_immigrations_dsr";
    $application_in_process_with_immigrations_dsr_res   = runQueryAllRows($dbh, $application_in_process_with_immigrations_dsr_qry, array());

    $mis_report_approved_by_immigrations_dsr_qry        = "select * from mis_report_approved_by_immigrations_dsr";
    $mis_report_approved_by_immigrations_dsr_res        = runQueryAllRows($dbh, $mis_report_approved_by_immigrations_dsr_qry, array());

    $mis_report_submited_on_ednrd_dsr_qry               = "select * from mis_report_submited_on_ednrd_dsr";
    $mis_report_submited_on_ednrd_dsr_res               = runQueryAllRows($dbh, $mis_report_submited_on_ednrd_dsr_qry, array());

    $mis_report_visa_uploaded_dsr_qry                   = "select * from mis_report_visa_uploaded_dsr";
    $mis_report_visa_uploaded_dsr_res                   = runQueryAllRows($dbh, $mis_report_visa_uploaded_dsr_qry, array());


    $mis_report_rejected_visa_dsr_qry                   = "select * from mis_report_rejected_visa_dsr";
    $mis_report_rejected_visa_dsr_res                   = runQueryAllRows($dbh, $mis_report_rejected_visa_dsr_qry, array());
        ...
        <div class="tab">
            ...
            <div id="dsr" class="tab-content">
                ...
                <div class="grid">
                    ...
                    <div class="col-20">
                        <strong class="count"><?php echo is_null($application_received_by_rca_dsr_res[0]['application_received_by_rca'])? 0 : $application_received_by_rca_dsr_res[0]['application_received_by_rca']; ?></strong>
                    </div>
                </div>
                <div class="grid">
                    <div class="col-70">
                    ...
                    <div class="col-20">
                        <strong class="count"><?php echo is_null($mis_report_submited_on_ednrd_dsr_res[0]['submited_on_ednrd'])? 0 : $mis_report_submited_on_ednrd_dsr_res[0]['submited_on_ednrd']; ?></strong>
                    </div>
                </div>
                <div class="grid">
                    <div class="col-70">
                    ...
                    <div class="col-20">
                        <strong class="count"><?php echo is_null($application_in_process_with_immigrations_dsr_res[0]['application_in_process_with_immigrations'])? 0 : $application_in_process_with_immigrations_dsr_res[0]['application_in_process_with_immigrations']; ?></strong>
                    </div>
                </div>
                <div class="grid">
                    <div class="col-70">
                    ...
                    <div class="col-20">
                        <strong class="count"><?php echo is_null($mis_report_approved_by_immigrations_dsr_res[0]['approved_by_immigrations'])? 0 : $mis_report_approved_by_immigrations_dsr_res[0]['approved_by_immigrations']; ?></strong>
                    </div>
                </div>
                <div class="grid">
                    <div class="col-70">
                    ...
                    <div class="col-20">
                        <strong class="count"><?php echo is_null($mis_report_visa_uploaded_dsr_res[0]['visa_copy_uploaded'])? 0 : $mis_report_visa_uploaded_dsr_res[0]['visa_copy_uploaded']; ?></strong>
                    </div>
                </div>
                <div class="grid">
                    <div class="col-70">
                    ...
                    <div class="col-20">
                        <strong class="count"><?php echo is_null($mis_report_rejected_visa_dsr_res[0]['rejected_visa'])? 0 : $mis_report_rejected_visa_dsr_res[0]['rejected_visa']; ?></strong>
                    </div>
                </div>
            </div>
            <!-- Third Tab -->

        ...
        <div class="container-fluid _cozy">
            ...
            <div class="row">
                ...
                <div class="col-md-12 _whitebox">
                    ...
                    <div id="hide_box ">
                        <div class="_select ">
                            <select name="filter-service ">
                                <option value=''>Select Service</option>
                                <?php foreach($rca_services as $sk => $sd) echo '<option value=" '.$sd['rca_service_id '].' ">'.$sd['service_name'].'</option>';?>
                            </select>
                        ...
                        <div class="_select ">
                            <select name="filter-status ">
                                <option value=''>Select Status</option>
                                    <?php foreach($rca_statuses as $sk => $sd) echo '<option value=" '.$sd['status_code '].' ">'.$sd['ta_status_name'].'</option>';?>
                            </select>
                            <i class="fa fa-angle-down _angle "></i> 
                        </div>
                        <!--                    
                            <div class="_select " id="financial_year ">                        
                                <input type="text " name="financial_year " placeholder="Financial Year " class="input " value=" " />                        
                                <i class="fa fa-calendar _angle "></i>                    
                            </div>                    
                        -->
                        <div class="_select ">
                            <input type="text " name="rca-search-filter " placeholder="Search " class="input " />
                            <i class="fa fa-search _angle "></i>
                        </div>
                        <div class="_support_search ">
                            <button type="button " class="__btn_sm __btn_active " onclick="searchOrders()">SEARCH</button>
                        </div>

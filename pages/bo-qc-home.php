<?php
    ...
    $page_code = 'BO_QC_HOME';
    $menu_page_code = 'BO_QC_HOME';
    /*
    */
    ...
    $stage_statuses=get_stage_statuses($dbh, 'QC','SERVICE');
    echo '<!--<PRE>';
    echo "Access: ", (($access===false)?"False":$access), "\n";
    print_r($stage_statuses);
    echo '</PRE>-->';
?>
<!DOCTYPE html>
<html lang="en">
...
<body style="background-color:#F3F5F7;">
                    ...
                    <div class="row">
                        <div class="col-md-12 __white_heading">
                            ...
                            <?php foreach($services as $k => $s) {
                                $cnt=get_stage_service_count($dbh, 'QC', $s['service_code']);
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6" id="para_hide" style="overflow-y: scroll;">
                    ...
                    <div class="col-md-12 _action_bottom">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="button" class="__btn_sm __btn_active submit_form" id="btn_save_close"> QC DONE</button>
    ...
    <script type="text/javascript">
        ...
        function getAppList(){
            ...
            ajax({method:'ajax_get_bo_application_list',start:ll_start,limit:ll_start+(ll_start==0?ll_init_size:ll_size)+1,search_str:sf,filters:filters,multi_sort:multisort,bo_stage:'QC',data_view:data_view},getAppListSuccess);
        ...
        function searchKeyUp(e) {
            ...
            if (e.which==13) {
                ...
                $('.table_new table tbody').html('');
                ajax({method:'ajax_get_bo_application_list',start:0,limit:1000,search_str:search,filters:{service_code:$('.service.current a').data('service-code'),status:''},multi_sort:[],bo_stage:'QC',data_view:data_view},getAppListSuccess);
            }
        }
        function getAppListSuccess(res){
            ...
            applist.forEach(function(app){
                console.log(app);
                var html='';
                html+='<tr data-row="app-row" data-app-service-id="'+app.application_service_id+'" style="cursor:pointer;" title="Click to open group" data-status="'+app.bo_status_name+'">';
                html+=' <td>';
        ...
        function showForm($t){
            $t=$t.parent().parent();
            $vm.data('app-service-id',$t.data('app-service-id')).data('status',$t.data('status'));
        ...
        function rejectChanged(){
            ...
            if ($vm.data('status')=='QC Done') $('#btn_save_close').hide();
            else $('#btn_save_close').show();
        }
        ...
        */
        ...
        function saveClose(submit){
            if (!dataChanged) {
                if (submit) {
                    ajax({method:'ajax_save_bo_service_status',app_service_id:$vm.data('app-service-id'),bo_stage:'QC',data_view:data_view});
                    $vm.modal('hide');
                    reGetAppList();
                }
                return;
        ...
        function rejectForm(){
            ...
            ajax({method:'ajax_save_service_reject',app_service_id:$vm.data('app-service-id'),rejectData:rejectData,bo_stage:'QC'},function(){$vm.modal('hide');});
        }
        $('document').ready(function(){

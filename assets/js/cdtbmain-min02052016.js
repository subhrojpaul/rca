...
function handleSize(){
	...
	$('.cd-tb-qstn-main').height($('.cd-tb-cont').height()-145);
...
function qLoad(qid,tsid,stype,ansid) {
	...
	if ($('#tb-option-1').find('img').attr('src') && !$('#cd-bkp-imgs').find('#ansimgs-'+qid).length) {
			$('#cd-bkp-imgs').append(
				'<div id="ansimgs-'+qid+'">'
					+'<img src="'+$('#tb-option-1').find('img').attr('src')+'">'
					+'<img src="'+$('#tb-option-2').find('img').attr('src')+'">'
					+'<img src="'+$('#tb-option-3').find('img').attr('src')+'">'
					+'<img src="'+$('#tb-option-4').find('img').attr('src')+'">'
	...
	l_req.done(function( data ) {
		...
		$('#tb-qimg').attr('src','');
		$('#tb-qnum').html('');
		$('#tb-option-1').find('img').attr('src','');
		$('#tb-option-2').find('img').attr('src','');
		$('#tb-option-3').find('img').attr('src','');
		$('#tb-option-4').find('img').attr('src','');
...
function qSave(qid,tsid,stype,ansid) {
	...
	l_req.done(function( data ) {
		...
		if (stype=='S') {
			...
			$(qpid).attr('data-ans','Y').removeClass('ans').addClass('ans');
...
function renderQuestionData(qid,data) {
	...
	$('#tb-option-1').find('img').attr('src',imgbase+a_qstn[5]);
	$('#tb-option-2').data("ansid",a_qstn[6]);
	$('#tb-option-2').find('img').attr('src',imgbase+a_qstn[7]);
	$('#tb-option-3').data('ansid',a_qstn[8]);
	$('#tb-option-3').find('img').attr('src',imgbase+a_qstn[9]);
	$('#tb-option-4').data('ansid',a_qstn[10]);
	$('#tb-option-4').find('img').attr('src',imgbase+a_qstn[11]);
...
$(document).ready(function() {
	...
	$("#tb-mark-btn").click(function(){
		...
		qSave($('#tb-qna').data('qid'),$('#tb-qna').data('tsid'),'M',ansid);

...
function renderFooter() {
	...
	<div class="row">
	<div class="aboutcol">
	About <br> <a href="../pages/cpabtus.php"> What is Cinepaly? </a> <br> <a
	href="../pages/cpcoinfo.php"> Company Information</a> <br> <a href="../pages/cpprtnrs.php">
	Partners </a> <br> <a href="../pages/cpjncnply.php"> Join the team</a> <br> <a
	href="../pages/cptnc.php"> Our Policies </a> <br>
	</div>
	<div class="aboutcol">
	Cineplay for Education <br> <i> [Coming soon] </i> <br>
	Partner School <br> Resourses <br> Production <br>
	Study Guide <br> Stage Craft <br> Teacher&lsquo;s Supplements <br>
	</div>
	<div class="aboutcol">
	Contact <br> <a href="../pages/cpprsenq.php"> Press/Media enquiries </a> <br>
	<a href="../pages/cpcstmrsprt.php"> Customer Support </a> <br> <a href="../pages/cpcontus.php">
	Contact us </a> <br>
	</div>
	<div class="aboutcol">
	Cineplay Archives <br> <i> [Coming soon] </i> <br>
	</div>
	</div>
	
	<div class="row">
	<div class="aboutcol">
	<font color="#000000"> 2013 CinePlay Digital Pvt Ltd. All
	Rights Reserved.</font>
	</div>
	
	<div class="aboutcol">
	<font color="#000000"> Designed by</font> <font color="#0052A3">
	Design Concentrate</font>
	</div>
	<div class="aboutcol">
	<font color="#000000"> Developed by</font> <font color="#0052A3">CinePlay</font>
	</div>
